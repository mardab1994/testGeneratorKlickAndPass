...
public class AnswearController5 {
	
	private MainController mainController;
	@FXML public Rectangle kafA = new Rectangle();
	@FXML public Rectangle kafB = new Rectangle();
	@FXML public Rectangle kafC = new Rectangle();
	@FXML public Rectangle kafD = new Rectangle();
	@FXML public Rectangle kafE = new Rectangle();
	...
	public void kafelekC(){
		System.out.println("klinales w kafelek C");
		ButtC*=-1;
		if(ButtC>0) {
			System.out.println("buttaC = "+ButtC);
			kafC.setStyle("-fx-fill: #62ff2d;");
			System.out.println("Zaznaczono C");
			sprawdzian.setOdpowiedz(actual, "C", 1);
		}
		else
			{
			kafC.setStyle("-fx-fill: #64b4ff;");
			System.out.println("Odznaczono C");
			sprawdzian.setOdpowiedz(actual, "C", 0);
			}
	}

	public void kafelekD(){
		System.out.println("klinales w kafelek D");
		ButtD*=-1;
		if(ButtD>0) {
			System.out.println("buttaD = "+ButtD);
			kafD.setStyle("-fx-fill: #62ff2d;");
			System.out.println("Zaznaczono D");
			sprawdzian.setOdpowiedz(actual, "D", 1);
		}
		else
			{
			kafD.setStyle("-fx-fill: #64b4ff;");
			System.out.println("Odznaczono D");
			sprawdzian.setOdpowiedz(actual, "D", 0);
			}
	}

	public void kafelekE(){
		System.out.println("klinales w kafelek E");
		ButtE*=-1;
		if(ButtE>0) {
			System.out.println("buttaE = "+ButtE);
			kafE.setStyle("-fx-fill: #62ff2d;");
			System.out.println("Zaznaczono E");
			sprawdzian.setOdpowiedz(actual, "E", 1);
		}
		else
			{
			kafE.setStyle("-fx-fill: #64b4ff;");
			System.out.println("Odznaczono E");
			sprawdzian.setOdpowiedz(actual, "E", 0);
			}
	}
	...
	public void odswiezOkno() {
		...
		if(sprawdzian.getOdpowiedz(actual, "E")==0) {
			ButtE=-1;
			kafE.setStyle("-fx-fill: #64b4ff;");
		}else {
			ButtE=1;
